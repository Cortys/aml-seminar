...
The \textit{\textbf{O}ptimal \textbf{S}ubsampling \textbf{M}otivated by the \textbf{A}-Optimality \textbf{C}riterion} (OSMAC)~\cite{Wang2017}\cite{Wang2018} method improves upon LCC by minimizing the expected variance.\
...
\begin{figure}
	...
	\end{subfigure}
	\caption{Comparison of the decision boundaries of KM-SVM and WKM-SVM.\\ \source{Bang2014}}\label{fig:wkmsvm:compare}
\end{figure}
