	...
	\begin{subfigure}{0.5\textwidth}
		\begin{tikzpicture}
			\begin{axis}[
				...
				xtick distance=1,
				ytick distance=0.02,
				xlabel={Total Number of Sampled Points \(\times 10^5\)},
				...
				\legend{Fixed \(|\mathcal{S}|\) to 5\%,Fixed \(|\mathcal{S}|\) to 100\%,{Dynamic \(|\mathcal{S}|\), \(\theta = 0.5\)}}
			\end{axis}
		\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		...
		\end{tikzpicture}
	\end{subfigure}
	\caption{}\label{fig:samplesize:eval}
\end{figure}
